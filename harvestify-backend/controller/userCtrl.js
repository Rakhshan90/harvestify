...
const generateResetPasswordTokenCtrl = expressAsyncHandler(async (req, res) => {
    ...
    try {
        ...
        const resetUrl = `If your were requested to reset your account, please reset your account within 10 mins, otherwise ignore this meassage <a href="https://harvestify-seven.vercel.app/reset-password/${token}">Click to verify your account<a/>`;
            ...
            body: {
                ...
                action: {
                    ...
                    button: {
                        ...
                        text: 'Reset Password',
                        link: `https://harvestify-seven.vercel.app/reset-password/${token}`
                    }
                },
